#!/usr/bin/env python3
"""Finalize and audit Formal profiler evidence across a strict trust boundary."""
...
def _replay_nsys_exports(
    ...
    with tempfile.TemporaryDirectory(prefix="formal-nsys-replay-") as temporary:
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Finalize or audit a Formal profiler bundle")
