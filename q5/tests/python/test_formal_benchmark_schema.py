...
def test_setup_and_request_records_accept_strict_resident_values() -> None:
    from scripts.formal_benchmark_schema import validate_request, validate_setup
...
def test_setup_schema_round_trips_complete_hybrid_auto_provenance() -> None:
    from scripts.formal_benchmark_schema import validate_setup
...
def test_request_recomputes_hash_from_exact_rows() -> None:
    from scripts.formal_benchmark_schema import validate_request
...
def test_request_csv_round_trip_requires_exact_header(tmp_path: Path) -> None:
    from scripts.formal_benchmark_schema import REQUEST_FIELDS, read_requests
