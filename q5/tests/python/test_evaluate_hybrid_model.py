    ...
    *,
    ...
    payload = {
        ...
        "formal_runner": {
            ...
            "matrix_payload": {
                "experiment_id": f"formal-sf{scale_factor}",
                "dataset": {
                    "path": dataset,
...
def test_summary_rejects_fixed_identity_not_matching_setup(
    ...
    summary_rows = [
        ["formal-sf1", "1", "fixed", "hybrid-arrow", "fixed", "0.5", "10", RESULT_HASH, "8"],
        ["formal-sf1", "1", "auto", "hybrid-arrow", "auto", "0.5", "10", RESULT_HASH, "9"],
    ]
    with (tmp_path / "summary.csv").open("w", newline="", encoding="utf-8") as handle:
