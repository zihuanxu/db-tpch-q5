...
struct result_t {
    ...
    int              nthreads;
    int              has_vector_join_stats;
    uint64_t         payload_width_bytes;
    uint64_t         vector_index_bytes;
    uint64_t         vector_total_bytes;
    uint64_t         total_extra_space_bytes;
    int              has_prvj_stats;
    uint64_t         partition_vector_total_bytes;
    uint64_t         partition_count;
    uint32_t         radix_bits;
    uint32_t         num_passes;
    int              has_npo_stats;
    uint64_t         npo_hash_table_bytes;
    uint64_t         npo_primary_hash_table_bytes;
    uint64_t         npo_overflow_hash_table_bytes;
    int              has_sortmerge_stats;
    uint64_t         sortmerge_buffer_bytes;
};
